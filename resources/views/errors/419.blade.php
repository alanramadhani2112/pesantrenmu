    ...
    <main class="spm-error-shell d-flex flex-column align-items-center justify-content-center min-vh-100 px-6 py-10" aria-labelledby="error-title">
        ...
        <section class="card card-flush spm-error-card w-100" data-ui-card="metronic">
            <div class="card-body text-center">
                <div class="symbol symbol-60px spm-error-mark spm-error-mark-warning mx-auto">
                    <div class="symbol-label">
                        <span class="spm-error-mark-symbol spm-error-mark-symbol-warning">!</span>
                    </div>
                </div>

                <div class="spm-error-code spm-error-code-warning">419</div>

                <h1 id="error-title" class="spm-error-title">Sesi Kedaluwarsa</h1>
