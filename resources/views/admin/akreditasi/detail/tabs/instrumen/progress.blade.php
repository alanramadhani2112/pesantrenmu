    ...
    <div class="p-5 d-flex flex-column gap-5">
                ...
                <div class="col-md-4">
                    <div class="border border-dashed border-gray-300 rounded p-4 h-100 bg-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                <div class="fw-bold text-gray-900">{{ $card['label'] }}</div>
        ...
        <div class="notice bg-light-primary border border-primary border-dashed rounded p-4" role="status">
            ...
            <div class="text-muted fs-7">
                NA1 dan NA2 adalah referensi asesor. NK adalah nilai kelompok dari ketua asesor. NV otomatis mengikuti NK saat belum ada nilai tersimpan, lalu dapat diverifikasi atau diubah admin.
