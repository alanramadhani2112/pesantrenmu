        ...
        <div class="row g-5">
            @if($scoreSummary['isIpr'])
                <div class="col-md-6">
                    <div class="bg-light-info rounded-3 p-4 text-center">
                        ...
                        <div class="fw-bolder fs-3x text-info">{{ $scoreSummary['iprScore'] }}</div>
            ...
            @foreach($scoreSummary['komponenDetails'] as $detail)
                <div class="col-md-6">
                    <div class="bg-light-primary rounded-3 p-4 text-center">
                        ...
                        <div class="fw-bolder fs-3x text-primary">{{ $detail['score'] }}</div>
            ...
            <div class="col-12">
                <div class="bg-light-success rounded-3 p-5 text-center">
                    ...
                    <div class="fw-bolder fs-3x text-success">{{ $scoreSummary['finalScore'] }}</div>
                    <div class="mt-3">
