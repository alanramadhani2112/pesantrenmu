...
<div>
    ...
    <form wire:submit="register" class="form w-100"
        ...
        <x-ui.form-field class="mb-6" label="Nama" for="name" :error="$errors->get('name')" data-validate="required">
        ...
        <x-ui.form-field class="mb-6" label="Password" for="password" :error="$errors->get('password')" x-data="{ show: false }" data-validate="required|min:8">
