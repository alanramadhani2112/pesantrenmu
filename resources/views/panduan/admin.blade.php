...
<x-panduan::section id="verifikasi-berkas" title="Verifikasi Berkas" subtitle="Admin memverifikasi kelengkapan dokumen yang diunggah pesantren sebelum diteruskan ke asesor.">
    <ol class="list-unstyled mb-0">
        ...
        <li class="d-flex align-items-start gap-3">
            <span class="badge badge-primary rounded-circle fw-semibold flex-shrink-0" style="width:28px;height:28px;display:flex;align-items:center;justify-content:center;">5</span>
            <div>
